...
const RequestTicket = () => {
  ...
  {/* Category and Sub-Category (Inline) */}
  <div className="form-group-inline">
    ...
    <div className="register-ticket-form-group">
      ...
      <div className="register-ticket-select-wrapper">
        ...
        <span className="register-ticket-select-chevron"><ChevronDown size={18} /></span>
        {formData.category && (
          <span
        ...
        {formData.files.map((file, index) => {
          ...
          return (
            <div key={index} className="file-item">
              ...
              <button type="button" className="file-remove-btn" onClick={() => handleFileRemove(file)}>
                <X size={18} />
              </button>
            </div>
          );
  ...
  <div className="form-buttons">
    ...
    <button type="button" className="cancel-btn" onClick={onCancel}>CANCEL REQUEST</button>
  </div>
</form>
