...
const rejectedTickets = [
  {
    number: 'TX0021',
    subject: 'Budget report rejected',
    department: 'Finance & Budgeting',
    category: 'Software',
    subCategory: 'Reporting',
    status: 'Rejected',
    dateCreated: '2025-04-04 11:00 AM',
    lastUpdated: '2025-04-04 11:45 AM',
  },
  {
    number: 'TX0131',
    subject: 'Request for additional hardware rejected',
    department: 'IT Department',
    category: 'Hardware',
    subCategory: 'Server',
    status: 'Rejected',
    dateCreated: '2025-04-05 09:30 AM',
    lastUpdated: '2025-04-05 10:15 AM',
  },
  // Add more "Rejected" tickets as needed
];
...
const RejectedTickets = () => {
  ...
  const currentTickets = rejectedTickets.slice(indexOfFirstTicket, indexOfLastTicket);

  const totalPages = Math.ceil(rejectedTickets.length / itemsPerPage);
