...
const closedTickets = [
  ...
  // Add more "Closed" tickets as needed
];
...
const ClosedTickets = () => {
  ...
  const currentTickets = closedTickets.slice(indexOfFirstTicket, indexOfLastTicket);

  const totalPages = Math.ceil(closedTickets.length / itemsPerPage);
